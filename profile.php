...
<div class="main-content app-content">
     ...
     <div class="">
      <div class="max-w-[75%] mx-auto">
        <div class="box">
          <ul
            class="nav nav-tabs tab-style-8 scaleX rounded m-4 profile-settings-tab gap-2 flex flex-wrap"
            id="myTab4"
            role="tablist"
          >
            <li class="nav-item me-1" role="presentation">
              <button
                type="button"
                class="nav-link !px-6 text-primary rounded-md bg-primary/10"
                data-hs-tab="#account-pane"
                role="tab"
              >
                Account
              </button>
            ...
            <li class="nav-item me-1" role="presentation">
              <button
                type="button"
                class="nav-link !px-6 text-primary rounded-md bg-primary/10"
                data-hs-tab="#notification-tab-pane"
                role="tab"
              >
                Notification
              </button>
            ...
            <li class="nav-item" role="presentation">
              <button
                type="button"
                class="nav-link !px-6 text-primary rounded-md bg-primary/10 active"
                data-hs-tab="#security-tab-pane"
                role="tab"
              >
                Security
              </button>
          ...
          >
            <div
              class="tab-pane show active overflow-hidden p-0 border-0 hidden"
              id="account-pane"
              role="tabpanel"
            >
              <div
                class="flex justify-between items-center mb-4 flex-wrap gap-1"
              >
                <div class="font-semibold block text-[15px]">
                  Account Settings :
                </div>
                <div class="ti-btn ti-btn-primary ti-btn-sm">
                  <i class="ri-loop-left-line leading-none me-2"></i>Restore
                  Changes
                </div>
              </div>
              <div class="grid grid-cols-12 sm:gap-x-6 gap-y-3">
                  ...
                  <div class="flex items-start flex-wrap gap-4">
                    ...
                    <div>
                      ...
                      <div class="btn-list mb-1">
                        <button
                          type="button"
                          class="ti-btn ti-btn-sm ti-btn-primary btn-wave waves-effect waves-light"
                        >
                          <i class="ri-upload-2-line me-1"></i>Change Image
                        </button>
                        <button
                          type="button"
                          class="ti-btn ti-btn-sm ti-btn-soft-primary1 btn-wave waves-effect waves-light"
                        >
                ...
                <div class="xl:col-span-6 col-span-12">
                  <label for="profile-designation" class="form-label"
                    >Designation :</label
                  >
                  <input
                    type="text"
                ...
                <div class="xl:col-span-6 col-span-12">
                  <label for="profile-language" class="form-label"
                    >Language :</label
                  >
                  <div
                    class="choices"
                  ...
                  >
                    ...
                    >
                      ...
                      <div class="choices__list" role="listbox">
                        <div
                          id="choices--profile-language-item-choice-1"
                        ...
                        <div
                          id="choices--profile-language-item-choice-2"
                        ...
                        <div
                          id="choices--profile-language-item-choice-3"
                ...
                <div class="xl:col-span-6 col-span-12">
                  <label for="profile-phn-no" class="form-label"
                    >Phone No :</label
                  >
                  <input
                    type="text"
            ...
            <div
              class="tab-pane overflow-hidden p-0 border-0 hidden"
              ...
              <div class="grid grid-cols-12 sm:gap-x-6 gx-5 gap-y-3">
                <div class="xl:col-span-12 col-span-12">
                  ...
                  <p class="text-xs mb-0 text-textmuted dark:text-textmuted/50">
                    Users can tailor their experience to receive alerts for the
                    types of events that matter to them.
                  </p>
                </div>
                <div class="xl:col-span-12 col-span-12">
                  <div class="flex items-top justify-between mt-3">
                    ...
                    <div
                      class="toggle on toggle-success mb-0 float-sm-end"
                  ...
                  <div class="flex items-top justify-between mt-3">
                    ...
                    <div
                      class="toggle toggle-success mb-0 float-sm-end"
                  ...
                  <div class="flex items-top justify-between mt-3">
                    ...
                    <div
                      class="toggle toggle-success on mb-0 float-sm-end"
            ...
            >
              ...
              <div class="sm:flex block items-top justify-between mt-3">
                <div class="w-50">
                  ...
                  <p class="text-xs mb-0 text-textmuted dark:text-textmuted/50">
                    This helps protect accounts from unauthorized access, even
                    if a password is compromised.
                  </p>
                </div>
                <a href="javascript:void(0);" class="link-primary underline"
                  >Set Up Verification</a
                >
              </div>
              <div class="sm:flex block items-top justify-between mt-3">
                <div class="w-50">
                  ...
                  <p class="text-xs mb-0 text-textmuted dark:text-textmuted/50">
                    This additional step helps ensure that the person attempting
                    to modify account details is the legitimate account owner.
                  </p>
                </div>
                <div class="form-check">
                  <input
          ...
          <div class="box-footer border-t-0">
            <div class="btn-list float-end">
              <button
                type="button"
                class="ti-btn bg-primarytint2color text-white btn-wave waves-effect waves-light"
              >
                Deactivate Account
              </button>
              <button
