...
(() => {
  ...
  let savedState = localStorage.getItem("limo_sidebar_toggled");
  if (savedState && window.innerWidth >= 992) {
    html.setAttribute("data-toggled", savedState);
  }
      ...
      switch (verticalStyle) {
        ...
        case "closed":
          ...
          if (shouldToggle) {
            ...
            localStorage.setItem("limo_sidebar_toggled", html.getAttribute("data-toggled") || "");
          }
          break;
        // icon-overlay
        case "overlay":
